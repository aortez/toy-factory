...
struct picosystem_game_demo_stats {
	...
	uint32_t garden_seed_creation_count;
	...
	uint16_t garden_node_count;
	uint16_t garden_moisture_total;
	uint16_t garden_maximum_generation;
