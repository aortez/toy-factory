...
#define PICOSYSTEM_PHYSICS_SOLVER_ITERATIONS             14U
#define PICOSYSTEM_PHYSICS_REVOLUTE_POSITION_ITERATIONS  10U
#define PICOSYSTEM_PHYSICS_PRISMATIC_POSITION_ITERATIONS 6U
#define PICOSYSTEM_PHYSICS_SLEEP_QUIET_TICKS             30U
